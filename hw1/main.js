...
//     document.write(`<div>${simpson.name} ${simpson.surname} ${simpson.age} ${simpson.info} <img src="${simpson.photo}">
// </div>`)
// }
// document.write(`</div>`);


// document.write(`<div class="simps_box">`);
// for (const simpson of simpsons) {
//     document.write(`<div class="simps">
// <h2> ${simpson.name} ${simpson.surname}. Age is - ${simpson.age}</h2>
// <p> ${simpson.info}</p>
// <img src="${simpson.photo}" alt="simpsons">
//
// </div>`)
// }
// document.write(`</div>`);
...
//     <h3> Class name - ${product.title} . Price - ${product.price} UAH.</h3>
